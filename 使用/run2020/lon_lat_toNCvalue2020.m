...
tic;
Lai19 = strcat('.\data\LP\MmaxLai_',NCyear_1(end-1:end),'_align.tif'); %%%%%%%%%19年植被动态
Fpar19 =strcat('.\data\LP\MmaxFpar_',NCyear_1(end-1:end),'_align.tif');
Lai20 = strcat('.\data\LP\MmaxLai_',NCyear(end-1:end),'_align.tif');        %%%%%%%%%20年植被动态 
Fpar20 =strcat('.\data\LP\MmaxFpar_',NCyear(end-1:end),'_align.tif');
%%%%%%%%%气候数据
