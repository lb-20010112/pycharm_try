...
data = csvread('C:\Users\DELL\Desktop\5类点\Final\Crop.csv');   
%%%%%%%%%%%%%%%%数据位置定义
Lai19 = 'H:\Liubo\data\LP\MmaxLai_19_align.tif';%点位Lai=NaN的已去除，此处做一个验证，生成的文件夹应连续且与点位数相同
